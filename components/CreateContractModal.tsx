...
const CreateContractModal: React.FC<CreateContractModalProps> = ({ isOpen, onClose, language }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-start sm:items-center justify-center p-0 sm:p-4 overflow-y-auto">
      <div className="fixed inset-0 bg-secondary/40 backdrop-blur-sm" onClick={onClose}></div>
      ...
      <div className="relative bg-white w-full sm:max-w-5xl h-auto min-h-full sm:min-h-0 sm:max-h-[95vh] sm:rounded-[2.5rem] shadow-2xl animate-in slide-in-from-bottom sm:zoom-in-95 duration-200 flex flex-col font-sans overflow-y-auto sm:overflow-hidden">
        ...
        <div className="p-6 md:p-10 flex-1 flex flex-col">
          <div className="flex items-center justify-between mb-8">
            ...
            <button onClick={onClose} className="text-gray-400 hover:text-secondary rounded-full w-10 h-10 flex items-center justify-center hover:bg-gray-100 transition-colors">
          ...
          <div className="mt-8 flex flex-col sm:flex-row justify-end gap-4 border-t border-gray-100 pt-8 pb-4">
            <button onClick={onClose} className="px-10 py-3 text-[11px] font-bold text-bodyText hover:text-secondary uppercase tracking-[0.2em] transition-colors">{t.cancel}</button>
