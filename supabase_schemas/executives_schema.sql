...
CREATE TABLE IF NOT EXISTS public.executives (
    ...
    account_status public.account_status_enum DEFAULT 'pending' NOT NULL,
    previous_status public.account_status_enum DEFAULT 'pending' NOT NULL,
...
COMMENT ON COLUMN public.executives.previous_status IS 'Status anterior do executivo, usado para restaurar após arquivamento';
...
COMMENT ON COLUMN public.customers.account_status IS 'Chaves para i18n: pending, active, denied, archiving, archived';
